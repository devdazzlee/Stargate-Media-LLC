...
const Service_Box2 = ({heading,paragraph,button,className}) => {
  useEffect(() => {
  ...
  return (
    <div className={`${className ? className + ' ft-text-animate' : 'service-wrap2 ft-text-animate'}`}>
