...
const Book_Editing_Banner = () => {
  return (
    ...
    <div>
     ...
     <div>
       <h1 className=' text-white text-4xl font-bold mb-2 themetextcolor'>Professional Book <br /> <span className='font-bold' >Editing Services </span></h1>
       <p className=' text-white para  font-semibold'>  Investing in professional book editing services is one of the best decisions a writer can make for their career. A skilled editor not only refines your manuscript but also helps you enhance your storytelling, character development, and overall narrative structure.
       </p>
