...
const GhostWriter_Banner = () => {
  return (
    ...
    <div>
     ...
     <div>
       <h1 className=' text-white text-4xl font-bold mb-2 themetextcolor'>Professional eBook <br /> <span className='font-bold' >Ghostwriters </span> <br />  for Hire</h1>
       <p className=' text-white para  font-semibold'>Are you looking to establish the authority of your brand in your industry? Do you need a reader magnet to offer to your clients and customers? Do you have a difficult time understanding how your ebook project will reach a successful conception?</p>
